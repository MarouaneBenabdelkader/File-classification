...
list_files = [f for f in list_files if os.path.isfile(f) and f != current_script]
...
for file in list_files:
    ...
    destination_dir_name = 'Divers'  # Default folder
    ...
    # Move the file
    os.rename(os.path.join(current_dir, file),
